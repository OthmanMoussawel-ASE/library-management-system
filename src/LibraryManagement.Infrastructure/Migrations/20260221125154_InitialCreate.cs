        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckoutRecords_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CheckoutRecords_Patrons_PatronId",
                        column: x => x.PatronId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckoutRecords_BookId_PatronId_Status",
                table: "CheckoutRecords",
                columns: new[] { "BookId", "PatronId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_CheckoutRecords_DueDate",
                table: "CheckoutRecords",
                column: "DueDate");

            migrationBuilder.CreateIndex(
                name: "IX_CheckoutRecords_PatronId",
                table: "CheckoutRecords",
                column: "PatronId");

            migrationBuilder.CreateIndex(
                name: "IX_Patrons_MembershipNumber",
                table: "Patrons",
